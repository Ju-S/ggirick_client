...
[2차 프로젝트: 기업 관리 전산 프로젝트 (그룹웨어)](https://ggirick.site)<br>
[2차 프로젝트: 기업 관리 전산 프로젝트 (그룹웨어 관리자)](https://ggirick-admin-frontend.web.app/)

-- 테스트용 아이디 목록<br>
공통 비밀번호: RlflrRlflr11@@

이대표, 10250004, 인사팀, 대표(관리자 사이트 사용 가능)<br>
강이사, 10250005, 개발팀, 이사<br>
김부장, 10250006, 마케팅팀, 부장<br>
권사원, 10250007, 개발팀, 사원<br>

### **해당 사이트는 매일 04:00시에 데이터베이스가 초기화됩니다.**
</details>
