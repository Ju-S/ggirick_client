...
export default function ChatRoomHeader() {
    ...
    const { selectedChannel, selectedChannelMember, selectedWorkspaceMember } = useChatStore();
            ...
            <header className="flex items-center justify-between border-b bg-base-100 p-4">
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex -space-x-2">
                        {Array.isArray(selectedChannelMember) && selectedChannelMember.length > 0 ? (
                            selectedChannelMember.map((m, i) => (
                                <div
                                    key={i}
