            ...
            <div className="flex flex-wrap items-center justify-between">
                <div className="flex items-center justify-start">
                    <button
                        ...
                        className="mr-2 cursor-pointer rounded-lg p-2 text-gray-600 hover:bg-base-100 hover:text-gray-900 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 md:hidden"
                    >
                        <svg
                            aria-hidden="true"
                            className="h-6 w-6"
                ...
                <div className="flex items-center lg:order-2">
                    ...
                    {/*Dropdown menu*/}
                    <div
                        className="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded rounded-xl bg-white text-base shadow-lg"
                    ...
                    >
                        ...
                        <div>
                            <a
                                href="#"
                                className="flex border-b px-4 py-3 hover:bg-base-100"
                            >
                                <div className="flex-shrink-0">
                                    ...
                                    />
                                    <div
                                        className="bg-primary-700 absolute -mt-5 ml-6 flex h-5 w-5 items-center justify-center rounded-full border border-base-100/40">
                                        <svg
                                            aria-hidden="true"
                    ...
                    <span className="font-semibold text-gray-900">
                      ...
                      @bonnie.green
                            ...
                            <a
                                href="#"
                                className="flex px-4 py-3 hover:bg-base-100"
                            >
                                <div className="flex-shrink-0">
                                    <img
                                        className="h-11 w-11 rounded-full"
                    ...
                    <span className="font-semibold text-gray-900">
                      Robert Brown
                        ...
                        <a
                            href="#"
                            className="text-md block bg-gray-50 py-2 text-center font-medium text-gray-900 hover:bg-base-100"
                        >
                    ...
                    <button
                        ...
                        className="rounded-lg p-2 text-gray-500 hover:bg-base-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300"
                    >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-4 p-4">
                            <a
                                href="#"
                                className="group block rounded-lg p-4 text-center hover:bg-base-100"
                            >
                                <svg
                                    aria-hidden="true"
                                    className="mx-auto mb-1 h-7 w-7 text-gray-400 group-hover:text-gray-500"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                    ...
                    {/*Dropdown menu*/}
                    <div
                        className="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded rounded-xl bg-white text-base shadow"
                        id="dropdown"
                    >
                ...
                kim@ggirick.site
                        ...
                        >
                            <li>
                                <a
                                    href="#"
                                    className="block px-4 py-2 text-sm hover:bg-base-100"
                                >
                                    내 정보
                                </a>
                            </li>
                        ...
                        >
                            <li>
                                <a
                                    href="#"
                                    className="flex items-center px-4 py-2 text-sm hover:bg-base-100"
                                >
                                    <svg
